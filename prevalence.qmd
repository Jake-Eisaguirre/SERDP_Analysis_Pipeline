...
for (i in 1:length(species_list)) {
  ...
  if (k > 2) {
      ...
      # save predictions
      write_rds(as.data.frame(newdata), here("outputs", "prevalence","mean_annual_seasonal_trend", paste(species_list[i],".rds")))
...
for (i in 1:length(species_list)) {
  ...
  if (k > 9) {
      ...
      # save predictions
      write_rds(as.data.frame(newdata), here("outputs", "prevalence", "unix_seasonal_trend", paste(species_list[i],".rds")))
